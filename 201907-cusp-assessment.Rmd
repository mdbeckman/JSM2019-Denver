...
*Funding--Penn State Center of Excellence in Science Education (Tombros Fellowship Program)*


# Assessment Goal  

**Measure learning outcomes of students upon completion of undergraduate statistics program (e.g. major)**

- snapshot of student learning outcomes;
- facilitate cohort comparisons for program evaluation; 
- probe competencies exposed through extracurricular or peripheral experiences;
...
- Align to (2014) ASA Curriculum Guidelines[^1]
- Comprehensive scope
- Easy to implement across institutions & years 
...
- ASA Guidelines cite 95 competencies aligned to 6 major topics
...
# CUSP Test Excerpt (partial item)
